...
- **제안서**: PPTX, 템플릿 `C:\한국부동산원\회사소개서_작업중_260916.pptx`, 구성 레퍼런스 `QDrive_대구시_AI고도화_보고용_260908_1530.pptx`(4장 구성·'제N장 | 절' 제목 형식). 원고: [docs/PROPOSAL-DRAFT.md](docs/PROPOSAL-DRAFT.md).
